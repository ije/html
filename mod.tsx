...
import {
  ...
  type UserConfig,
  type Preset
} from "https://esm.sh/@unocss/core@0.34.1";
import presetWind from "https://esm.sh/@unocss/preset-wind@0.34.1?bundle&no-check";
...
export interface Options extends HtmlOptions {
  body: VNode;
  unocss?: Omit<UserConfig, "presets">;
  status?: number;
  headers?: HeadersInit;
}
